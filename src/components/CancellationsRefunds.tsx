...
import { Heart, ArrowLeft, RefreshCw, XCircle, AlertTriangle, CheckCircle } from 'lucide-react';

interface CancellationsRefundsProps {
  onBack: () => void;
}

function CancellationsRefunds({ onBack }: CancellationsRefundsProps) {
  return (
